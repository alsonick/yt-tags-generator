...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-[#111111] duration-300 items-center w-screen h-screen">
      <Head>
      ...
      <div className="flex flex-col lg:w-[45rem] w-[90%] items-center justify-center">
        <header className="text-center relative pt-10 mb-5">
          <h1 className="text-black dark:text-white text-3xl tracking-tight font-bold">
            {title
              ? title
                  .split("", 67)
                  .reduce(
          ...
          <p className="text-gray-800 dark:text-gray-400 mt-5 text-left">
        ...
        <div className="mt-5 w-full">
          {tags.length ? (
            ...
            <div className="mt-10">
              <h1 className="text-gray-300 dark:text-gray-800 font-bold tracking-tight text-2xl">
                {loading
                  ? "Generating..."
                  : networkingError
                  ? networkingError
